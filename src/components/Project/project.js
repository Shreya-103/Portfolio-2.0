const project = [
  ...
  },
  {
    ...
    description:
      "Full-stack A role-based employee entry management system; Features separate employee and admin login authentication with a responsive UI.; Made during internship at BEL , Employee credentials for login: EmployeeID: UPT223 | Password: 12345, Admin credentials:- username: admin | password: 1234",
